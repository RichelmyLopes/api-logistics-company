import { DirectionsRequest, Client as GoogleMapsCliente, TravelMode} from '@googlemaps/google-maps-services-js';
...
export class DirectionsService {
    ...
    async getDirections(placeOriginId: string, placeDestinationId: string){
        ...
        const {data} = await this.googleMapsCliente.directions({
